...
h_xJg_50_70 = inFile.Get("h_xJg_50_70")
h_xJg_70_100 = inFile.Get("h_xJg_70_100")
h_xJg_100_150 = inFile.Get("h_xJg_100_150")
...
h_xJg_50_70.Scale(1.0/h_xJg_50_70.Integral());
h_xJg_70_100.Scale(1.0/h_xJg_70_100.Integral());
h_xJg_100_150.Scale(1.0/h_xJg_100_150.Integral());
...
h_xJg_50_70.GetXaxis().SetTitle("xJGamma (50 GeV < pT(photons) < 70 GeV)");
h_xJg_50_70.GetYaxis().SetTitle("# entries");
c8 = ROOT.TCanvas("c8")
h_xJg_50_70.Draw("COLZ")
c8.Print("h_xJg_50_70.pdf")

h_xJg_70_100.GetXaxis().SetTitle("xJGamma (70 GeV < pT(photons) < 100 GeV)");
h_xJg_70_100.GetYaxis().SetTitle("# entries");
c9 = ROOT.TCanvas("c9")
h_xJg_70_100.Draw("COLZ")
c9.Print("h_xJg_70_100.pdf")

h_xJg_100_150.GetXaxis().SetTitle("xJGamma (100 GeV < pT(photons) < 150 GeV)");
h_xJg_100_150.GetYaxis().SetTitle("# entries");
c10 = ROOT.TCanvas("c10")
h_xJg_100_150.Draw("COLZ")
c10.Print("h_xJg_100_150.pdf")
